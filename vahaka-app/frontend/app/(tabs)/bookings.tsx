...
import { View, StyleSheet, FlatList, TouchableOpacity, ActivityIndicator, RefreshControl, Alert, Platform } from 'react-native';
      ...
      <View style={styles.bookingDetails}>
        <View style={styles.detailItem}>
          ...
          <ThemedText style={styles.detailText}>
            {formatDate(item.startDate as Date)} - {formatDate(item.endDate as Date)}
          </ThemedText>
        </View>
